...
import { ArrowLeft, Share2, DollarSign, CalendarDays, ClipboardList } from "lucide-react"
...
const statusOptions = [
  "active_contingent",
  "active_noncontingent",
  "closed",
  "seller_in_possession",
  "cancelled",
  "pre_listing",
  "listed",
  "prospecting",
...
const StatCard = ({ icon: Icon, label, value, color, onClick, clickable = false }: any) => (
  <div
        ...
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-4">
            <Link href="/transactions">
              <Button variant="outline" size="icon" className="clay-element border-0 w-12 h-12 bg-transparent">
              ...
              value={
                <div>
                  ...
                  <p className="text-xs font-normal text-gray-500">
                    EMD: ${transaction.emd_amount?.toLocaleString() || "N/A"}
                  </p>
                </div>
              }
              color="bg-green-400"
