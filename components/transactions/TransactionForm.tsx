...
export default function TransactionForm({ transaction = null, onSubmit, onCancel }: any) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4 mb-6">
        <Button variant="outline" size="icon" onClick={onCancel} className="clay-element border-0 bg-transparent">
          <ArrowLeft className="w-4 h-4" />
        </Button>
        <div>
          <h1 className="text-3xl font-bold text-gray-900">{transaction ? "Edit Transaction" : "New Transaction"}</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card className="clay-element border-0">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <Select value={formData.agent_side} onValueChange={(value) => handleInputChange("agent_side", value)}>
                <SelectTrigger className="clay-element border-0 mt-1">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("year_built", Number.parseInt(e.target.value))}
                placeholder="1985"
                className="clay-element border-0 mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("property_sf", Number.parseInt(e.target.value))}
                placeholder="2500"
                className="clay-element border-0 mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("property_lot_sf", Number.parseInt(e.target.value))}
                placeholder="7500"
                className="clay-element border-0 mt-1"
              />
            </div>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("sales_price", Number.parseFloat(e.target.value))}
                placeholder="750000"
                className="clay-element border-0 mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("emd_percentage", Number.parseFloat(e.target.value))}
                placeholder="3.0"
                className="clay-element border-0 mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("commission_listing", Number.parseFloat(e.target.value))}
                placeholder="22500"
                className="clay-element border-0 mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("commission_buyer", Number.parseFloat(e.target.value))}
                placeholder="22500"
                className="clay-element border-0 mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("home_warranty_amount", Number.parseFloat(e.target.value))}
                placeholder="500"
                className="clay-element border-0 mt-1"
              />
            </div>
        ...
        <div className="flex justify-end gap-4 pt-6">
          <Button
            ...
            variant="outline"
            onClick={onCancel}
            className="clay-element border-0 px-6 bg-transparent"
          >
            Cancel
          </Button>
          <Button type="submit" className="clay-element clay-accent-mint border-0 px-6">
