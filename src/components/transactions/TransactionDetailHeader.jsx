...
export default function TransactionDetailHeader({ transaction }) {
  const getStatusColor = (status) => {
    switch (status) {
      case 'active': return 'clay-accent-mint text-green-700';
      case 'pending': return 'clay-accent-blue text-blue-700';
      case 'closed': return 'clay-accent-lavender text-purple-700';
    ...
    <div className="flex justify-between items-start">
      <div className="flex items-start gap-4">
        <Link to={createPageUrl("Transactions")}>
          <Button variant="outline" size="icon" className="clay-element border-0">
