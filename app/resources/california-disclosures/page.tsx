...
const HighlightCard = ({ icon, title, description, color = "blue" }) => (
    ...
    <div className="flex min-h-screen flex-col">
      <div className="flex-1">
        <div style={{ display: "none" }}>
          <meta
            name="description"
            content="Discover California's required seller disclosures, safety booklets, and AB-38 wildfire compliance forms for residential and commercial real estate sales."
          />
          <meta
            name="keywords"
            content="California real estate disclosures, California seller disclosure requirements, AB-38 fire safety disclosure, defensible space law California, California home hardening requirements, California home sale booklets, real estate disclosure forms California, California residential safety booklets"
          />
        ...
        <div className="bg-white">
          <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
            ...
            <p className="text-lg text-gray-600">
              A guide to state-mandated booklets and disclosures for residential and commercial transactions in
              California, providing critical information on safety, environmental hazards, and property conditions.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 pb-20 space-y-16">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-8">
                According to the California Department of Forestry and Fire Protection (CAL FIRE), approximately one in
                four homes in the state are located in High or Very High Fire Hazard Severity Zones (FHSZ). Assembly
                Bill 38 (AB-38) created California's first statewide fire retrofit program, creating critical disclosure
                and compliance requirements for sellers in these zones.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <HighlightCard
                  ...
                  description="Sellers must disclose if the property is in a High or Very High Fire Hazard Severity Zone."
                  color="red"
                />
                <HighlightCard
                  icon="🛡️"
                  title="Defensible Space"
                  description="Properties near flammable vegetation must maintain at least 100 feet of defensible space."
                  color="green"
                />
              </div>
              ...
              <div className="p-8 md:p-10 bg-blue-50/70 rounded-2xl border border-blue-100">
                ...
                <div className="space-y-4">
                  <RequirementItem date="Jan 1, 2020">
                    For new construction, sellers must provide the buyer with a copy of the final inspection report
                    regarding home hardening compliance.
                  </RequirementItem>
                  <RequirementItem date="Jan 1, 2021">
                    For homes built before 2010, sellers must provide written notice of fire-hardening best practices
                    and features that make the home vulnerable.
                  </RequirementItem>
                  <RequirementItem date="Jul 1, 2021">
                    Sellers must provide documentation proving compliance with state defensible space laws and local
                    vegetation management ordinances.
                  </RequirementItem>
                  <RequirementItem date="Jul 1, 2021">
                    If compliance documentation is unavailable, buyer and seller must agree in writing for compliance to
                    be achieved within one year of closing.
                  </RequirementItem>
                  <RequirementItem date="Jul 1, 2025">
                    Sellers must provide a list of low-cost retrofits to harden the home and disclose which, if any,
                    have been completed.
                  </RequirementItem>
                </div>
              </div>
              <p className="text-sm text-gray-600 mt-8">
                High and Very High Fire Hazard Severity Zones have been part of California&apos;s legally required real
                estate disclosures for decades. AB-38 strengthens these protections by requiring sellers to be more
                proactive in disclosing compliance with fire safety standards.
              </p>
              <a
              ...
              >
                <Button>Learn More at fire.ca.gov 🔗</Button>
              </a>
            </div>
